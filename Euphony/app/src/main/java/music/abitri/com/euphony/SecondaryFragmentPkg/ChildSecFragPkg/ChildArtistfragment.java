 ...
 */
public class ChildArtistfragment extends Fragment {


    public static ChildArtistfragment newInstance(Artistinfo detail) {
        Bundle bundle = new Bundle();
        if (detail != null) {
            bundle.putSerializable(Constants.ARTIST_KEY, detail);
            bundle.putString("TYPE_KEY","ARTIST");
        } else {
            Log.d("error", "null value");
        }
        ChildArtistfragment f = new ChildArtistfragment();
    ...
    private void setImage(View view) {
        frissonView = (FrissonView) view.findViewById(R.id.artist_art_view);
        child_dtl_view = (RecyclerView) view.findViewById(R.id.child_arts_view);
        albumname = (TextView) view.findViewById(R.id.artist_nm_id);
        ...
        detail = (Artistinfo) bundle.getSerializable(Constants.ARTIST_KEY);
        albumname.setText(detail.getArtistName());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_child_artistfragment, container, false);
        UIsetup(true);
        setImage(view);
    ...
    private class ChildAsynctask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            songList = getter.getChildArtistList(getActivity(), detail.getArtistName());
            type = "ARTIST";
            retrive_type = detail.getArtistName();
            return null;
        }
